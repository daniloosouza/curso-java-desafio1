...
Aplicação bancária para gerenciamento de contas por parte da instituição financeira.
A aplicação permite as seguintes funções:
...
#### Listagem
Listagem das contas bancárias existentes no sistema

#### Depósito
Depósito de valor em conta informada pelo usuário

#### Saque
Saque de valor de conta informada pelo usuário
...
Exportação de histórico de transações em arquivo com formato .csv
